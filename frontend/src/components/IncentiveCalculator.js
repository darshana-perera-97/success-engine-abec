...
const IncentiveCalculator = ({ students = [], employees = [] }) => {
  ...
  const {
    pageItems: paginatedIncentiveData,
    page,
    setPage,
    pageSize,
    setPageSize,
    totalRows,
  } = useClientPagination(incentiveData, incentiveData.length);
  return /* @__PURE__ */ jsxs("div", { className: dt.card, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: dt.scroll, children: /* @__PURE__ */ jsxs("table", { className: dt.table, children: [
      ...
      /* @__PURE__ */ jsx("tbody", { className: dt.body, children: paginatedIncentiveData.map((agent) => /* @__PURE__ */ jsxs("tr", { className: dt.row, children: [
