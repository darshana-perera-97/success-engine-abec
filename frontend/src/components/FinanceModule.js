...
const generateInvoiceImageDataUrl = async ({ invoice, student, paymentAccount }) => {
  try {
    ...
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="${svgHeight}" viewBox="0 0 1200 ${svgHeight}">
      ...
      <text x="88" y="190" font-family="Arial, sans-serif" font-size="34" font-weight="700" fill="#1e293b">${escapeInvoiceSvgText(`${COMPANY_NAME} Invoice`)}</text>
      <text x="88" y="238" font-family="Arial, sans-serif" font-size="19" fill="#475569">Invoice ID: ${invoiceId}</text>
      <text x="88" y="290" font-family="Arial, sans-serif" font-size="17" fill="#64748b">Student</text>
      <text x="88" y="328" font-family="Arial, sans-serif" font-size="24" font-weight="600" fill="#0f172a">${studentName}</text>
      <text x="88" y="390" font-family="Arial, sans-serif" font-size="17" fill="#64748b">Description</text>
      <text x="88" y="428" font-family="Arial, sans-serif" font-size="22" fill="#0f172a">${description}</text>
      <text x="88" y="490" font-family="Arial, sans-serif" font-size="17" fill="#64748b">Issue Date</text>
      <text x="88" y="528" font-family="Arial, sans-serif" font-size="22" fill="#0f172a">${issuedDate}</text>
      <text x="88" y="570" font-family="Arial, sans-serif" font-size="17" fill="#64748b">Due Date</text>
      <text x="88" y="608" font-family="Arial, sans-serif" font-size="22" fill="#0f172a">${dueDate}</text>
      <rect x="760" y="240" width="340" height="220" rx="20" fill="#eef2ff" stroke="#c7d2fe" />
      <text x="790" y="310" font-family="Arial, sans-serif" font-size="17" fill="#4338ca">Total Amount</text>
      <text x="790" y="380" font-family="Arial, sans-serif" font-size="36" font-weight="700" fill="#312e81">${escapeInvoiceSvgText(amount)}</text>
      ${payLines.length ? `<text x="88" y="650" font-family="Arial, sans-serif" font-size="16" fill="#64748b">Pay to</text>
      <text x="88" y="688" font-family="Arial, sans-serif" font-size="19" fill="#0f172a">${payLines[0] || ""}</text>
      <text x="88" y="724" font-family="Arial, sans-serif" font-size="17" fill="#334155">${payLines[1] || ""}</text>` : ""}
      <text x="88" y="${svgHeight - 96}" font-family="Arial, sans-serif" font-size="14" font-weight="400" fill="#b8c0cc">${escapeInvoiceSvgText(PAYMENT_NOT_REFUNDABLE_NOTICE)}</text>
      <text x="760" y="${svgHeight - 60}" font-family="Arial, sans-serif" font-size="16" fill="#64748b">Generated by ${escapeInvoiceSvgText(COMPANY_NAME)}</text>
    </svg>`;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400", children: PAYMENT_NOT_REFUNDABLE_NOTICE })
      ] }),
    ...
    isPaymentModalOpen && selectedInvoiceIds.length > 0 && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 overflow-y-auto overscroll-contain flex items-start justify-center py-8 px-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl border border-gray-100 shadow-2xl p-6 w-full max-w-lg scale-100 animate-in zoom-in-95 max-h-[90vh] overflow-y-auto my-auto", children: [
      ...
      !canUploadEvidence && selectedPaymentInvoices[0] && /* @__PURE__ */ jsxs("div", { className: "mb-6 bg-slate-50 p-4 rounded-lg border border-slate-100", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 mt-3", children: PAYMENT_NOT_REFUNDABLE_NOTICE })
      ] }),
